...
<head>
    ...
    <link type="text/css" rel="stylesheet"
          href="${pageContext.request.contextPath}/resources/lib/ext-4.2.2.1144/resources/css/ext-all-gray.css"/>
    ...
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/resources/lib/ext-4.2.2.1144/examples/ux/statusbar/css/statusbar.css">

    <c:choose>
        <c:when test="${mode == 'development'}">
            <script type="text/javascript"
                    src="${pageContext.request.contextPath}/resources/lib/ext-4.2.2.1144/ext-all-debug-w-comments.js"></script>
        </c:when>
        <c:otherwise>
            <script type="text/javascript"
                    src="${pageContext.request.contextPath}/resources/lib/ext-4.2.2.1144/ext-all.js"></script>
        </c:otherwise>
    </c:choose>
    ...
    <c:choose>
        <c:when test="${locale == 'Korean'}">
            <script type="text/javascript"
                    src="${pageContext.request.contextPath}/resources/lib/ext-4.2.2.1144/locale/ext-lang-ko.js"></script>
        </c:when>
        <c:when test="${locale == 'Japanese'}">
            <script type="text/javascript"
                    src="${pageContext.request.contextPath}/resources/lib/ext-4.2.2.1144/locale/ext-lang-ja.js"></script>
        </c:when>
        <c:otherwise>
            <script type="text/javascript"
                    src="${pageContext.request.contextPath}/resources/lib/ext-4.2.2.1144/locale/ext-lang-en.js"></script>
        </c:otherwise>
    </c:choose>
    ...
    <!-- Highchart -->
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/resources/lib/highcharts-3.0.5/js/highcharts.js"></script>
    ...
    <script type="text/javascript">
        ...
        Ext.Loader.setPath({
            ...
            'Ext.ux': '${pageContext.request.contextPath}/resources/lib/ext-4.2.2.1144/examples/ux',
